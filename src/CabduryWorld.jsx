...
const CabduryWorld = () => {
  ...
  <div>
   {/* <div className="cont h-[70vh] mt-0 flex bg-purple-950">
      ...
      <div   className='h-[70vh] div bg-white flex gap-[2%] justify-center items-center overflow-hidden cards-parent'> {["https://images.ctfassets.net/pmzhtobns06n/3ONtvIDWHyo8PShhOTZ4jB/f0bdb7c7f76bb94f7bdcb6a713dd767a/_Brandlogos_CDM.jpg?fm=webp&q=80",
