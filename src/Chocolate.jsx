...
function Chocolate() {
  ...
  return (
    <div className="w-screen ">
      ...
      <p className='z-9 text-[4vh] py-8   text-center title  text-white'>Think Cadbury, think chocolate. Chocolate bars, blocks and bites - all different types of chocolate and chocolate flavours. So delicious, so moreish.</p>
