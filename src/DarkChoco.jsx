...
function DarkChoco() {
  ...
  return (
    <div className="w-screen">
      ...
      <p className='z-9 text-[4vh] py-8 text-white  text-center title '>Dark and intense Bournville, rich and creamy Darkmilk... It’s all about the cocoa with our dark chocolate, with just the right level of sweetness.</p>
      ...
      <div className="grid grid-cols-3 gap-x-[0.8vw] gap-y-[15vh] mx-[10%] our-products-container mb-[10vh]   max-w-screen pb-[10vh] ">
        {[
         {image:"https://images-tastehub.mdlzapps.cloud/images/cdd9addf-8523-4765-9a19-0fd1b03a568f.png?fm=webp&q=80" ,
               ...
               para:"CADBURY BOURNVILLE classNameIC DARK CHOCOLATE BAR, 100G",
               h4:"bournville"},
          ...
          >
            <div className='absolute w-[22vw] h-[35vh] img-round bg-[#4b0983] top-1/2 rounded-tl-[60%] rounded-b-xl '></div>
            <h5 className="absolute left-[5%] bg-[#ebc373] rounded-xl px-2 top-2 text-white ">{item.h4}</h5>
            <img
              key={index}
              className={`w-[50vw] z-9 absolute  our-product-img  top-[30%]  left-1/2 -translate-x-1/2 -translate-y-1/2 ${
                isHover[index] ? 'hovered' : ''
              }`}
              ...
              alt="Milk Chocolate"
            />
            <p className="text-[2vh] absolute text-white bottom-[5%] px-2" >{item.para}</p>
          </div>
        ))}
      </div>
    </div>
