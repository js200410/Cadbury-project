...
const Footer = () => {
  return (
    <div classNameNameNameName='h-screen bg-white'>
      <div  classNameNameNameName='bg-purple-900 h-[40vh]'>
        <img classNameNameNameName=" float-right h-[40vh]" src="https://images.ctfassets.net/pmzhtobns06n/FylNgIq5k8uYLgdPsRNC3/2d5134c6f611132106fcd3229a9f416e/Cadbury_MilkPourMaster.png?fm=webp&q=80&fm=webp&q=80" alt="" />
      </div>
      <div classNameNameNameName='border-b-2 border-purple-900 h-[30vh] flex justify-between items-center p-4'>
            ...
            <div classNameNameNameName='flex h-[6vh] gap-[3vh]'>
      ...
      <div classNameNameNameName='font-sans flex justify-between '>
        {["© 2024 Mondelez United Kingdom","TERMS OF USE","PRIVACY NOTICE","COOKIE NOTICE","ACCESSIBILITY","T&Cs",
"CONTACT US"].map((index,value)=>{
    return <a key={index} href="" classNameNameNameName="font-sans mt-[10vh] font-semibold">{index}</a>
})}
      </div>
    </div>
  )
