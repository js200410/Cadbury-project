...
const Slider = () => {
  ...
  return (
    <>
      ...
      ><SwiperSlide className='swiper-slide1 bg-no-repeat bg-cover  bg-[url("https://mir-s3-cdn-cf.behance.net/project_modules/1400/1c7e77128954427.6160b3c820d33.jpg")]'>
        <h1 className='title top-[10vh]  text-yellow-50 capitalize italic font- text-[5vh]  font-extrabold'>Our chocolate makers are always inventing new ways to enjoy Cadbury chocolate. Take a look at our latest products here!</h1>
      </SwiperSlide>
        ...
        <SwiperSlide className='swiper-slide bg-no-repeat bg-cover bg-[url("https://images.pexels.com/photos/6985127/pexels-photo-6985127.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")]'>
          ...
          <h1 className='text-[hotpink] font-bold text-[5vh] bold '>Cadbury Bournville Dark Chocolate</h1>
        </SwiperSlide>
